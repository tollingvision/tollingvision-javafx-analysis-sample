...
class ValidationLoggerTest {
    ...
    void testLogEntriesByCategory() {
        ...
        List<ValidationLogger.LogEntry> userActions = ValidationLogger.getLogEntriesByCategory("USER_ACTION", 10);
        assertEquals(2, userActions.size());
        
        List<ValidationLogger.LogEntry> configChanges = ValidationLogger.getLogEntriesByCategory("CONFIG_CHANGE", 10);
