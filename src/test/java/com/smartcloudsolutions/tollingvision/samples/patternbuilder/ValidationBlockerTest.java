...
class ValidationBlockerTest {
    ...
    void testGetMostCriticalError() {
        ...
        ValidationError highPriorityError = ValidationError.of(ValidationErrorType.NO_GROUP_ID_SELECTED);
        ValidationResult errorResult = ValidationResult.failure(List.of(lowPriorityError, highPriorityError));
    ...
    void testGetErrorDetails() {
        ValidationError error1 = ValidationError.of(ValidationErrorType.NO_GROUP_ID_SELECTED);
        ValidationError error2 = ValidationError.of(ValidationErrorType.INVALID_GROUP_PATTERN, "Custom message");
        ValidationResult errorResult = ValidationResult.failure(List.of(error1, error2));
    ...
    void testGetWarningDetails() {
        ...
        ValidationWarning warning2 = ValidationWarning.of(ValidationWarningType.INCOMPLETE_GROUP_COVERAGE, "Custom warning");
