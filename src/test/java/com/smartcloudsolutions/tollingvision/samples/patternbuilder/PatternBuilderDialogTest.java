...
/**
 * Test class for PatternBuilderDialog functionality.
 * Tests dialog creation, mode switching, and configuration handling.
 */
class PatternBuilderDialogTest {
    ...
    void setUp() throws Exception {
        ...
        Platform.runLater(() -> {
            dialog = new PatternBuilderDialog("/test/folder", java.util.ResourceBundle.getBundle("messages"));
            latch.countDown();
        });
