...
/**
 * User configuration data model for the TollingVision application. Contains all
 * user-configurable
...
public class UserConfiguration {
  ...
  public UserConfiguration(
      ...
      PatternBuilderConfig patternBuilderConfig) {
  ...
  public PatternBuilderConfig getPatternBuilderConfig() {
    return patternBuilderConfig;
  }
  ...
  public static class Builder {
    ...
    public Builder(UserConfiguration existing) {
      this.config = new UserConfiguration(
          existing.inputFolder,
          existing.serviceUrl,
          existing.tlsEnabled,
          existing.insecureAllowed,
          existing.csvDirectory,
          existing.maxParallel,
          existing.groupPattern,
          existing.frontPattern,
          existing.rearPattern,
          existing.overviewPattern,
          existing.patternBuilderConfig != null
              ? existing.patternBuilderConfig.copy()
              : new PatternBuilderConfig());
    }
