...
/**
 * Represents a rule for classifying filenames into image roles. Rules are
 * applied in priority order
 * to determine whether a filename matches a specific image role (front, rear,
 * overview).
 */
public class RoleRule {
  ...
  public String toString() {
    return String.format(
        "RoleRule{role=%s, type=%s, value='%s', caseSensitive=%s, priority=%d}",
