...
/**
 * Represents a validation error that prevents pattern usage.
 * Errors must be resolved before the pattern can be used.
 */
public class ValidationError {
    ...
    public String toString() {
        return String.format("ValidationError{type=%s, message='%s', context='%s'}",
