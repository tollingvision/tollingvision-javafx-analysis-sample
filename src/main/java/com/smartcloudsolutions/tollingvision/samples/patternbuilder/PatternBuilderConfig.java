...
/**
 * Configuration class for storing Pattern Builder specific settings. This class
 * holds the visual
 * rule-based configuration that can be persisted and restored, allowing users
 * to maintain their
 * pattern building preferences.
 */
public class PatternBuilderConfig {
  ...
  public String toString() {
    return String.format(
        "PatternBuilderConfig{roleRules=%d, tokens=%d, "
