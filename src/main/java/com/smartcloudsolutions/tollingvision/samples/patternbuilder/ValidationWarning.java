...
/**
 * Represents a validation warning that indicates a potential issue
 * but doesn't prevent pattern usage.
 */
public class ValidationWarning {
    ...
    public String toString() {
        return String.format("ValidationWarning{type=%s, message='%s', context='%s'}",
