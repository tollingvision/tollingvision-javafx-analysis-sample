 ...
 * by the current pattern configuration. Used in the PatternPreviewPane to
 * display
 * real-time feedback on pattern matching results.
 */
public class FilenamePreview {
     ...
     */
    public FilenamePreview(String filename, String groupId, ImageRole role, boolean matched, String errorMessage) {
    ...
    public String toString() {
        return String.format("FilenamePreview{filename='%s', groupId='%s', role=%s, matched=%s, error='%s'}",
